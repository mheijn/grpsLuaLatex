...
if gramps6 and not gramps6.Event then
    gramps6.Event      = gramps6.DataSet('Event',gramps6.Queries)
    gramps6.Event.__file = debug.getinfo(1, "S").source:sub(2)
    ...
    gramps6.Event.Map = MAP

    gramps6.Event.LifeEvents={TYPE.BIRTH, TYPE.BAPTISM, TYPE.DEATH, TYPE.BURIAL, TYPE.CREMATION, TYPE.ADOPT}

    gramps6.Event.Family =
...
--[[
    ...
    function gramps6.Event:long(weekday,type)
        if type and self.type.number ~= type then return "" end
