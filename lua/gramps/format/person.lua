pic=require("gramps.format.pictures")
...
function events(p,ty)
    ...
    local event_groups ={--{group,true:Hij/Zij false:Zijn/Haar}
            {
            {gramps.Event.LifeEvents,true},
            {gramps.Event.Religious,false},
            {gramps.Event.Vocational,true},
            {gramps.Event.Academic,true},
            {gramps.Event.Travel,true},
            {gramps.Event.Legal,true},
            {gramps.Event.Residence,true}
            },
            {{gramps.Event.Family,true}},
            {{gramps.Event.LifeEvents,true}}
            }
